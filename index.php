...
<html>
   <head>
     <title>Read Excel Sheet in Browser using PHPSpreadsheet</title>
   ...
   <body>
     <div class="container">
      <br />
      <h3 align="center">Read Excel Sheet Data In Browser Using PHPSpreadsheet.</h3>
      <br >
      <div class="table-responsive">
       <span id="message"></span>
          <form method="post" id="load_excel_form" enctype="multipart/form-data">
            <table class="table">
              <tr>
                <td width="25%" align="right"><strong>Select Excel File</strong></td>
